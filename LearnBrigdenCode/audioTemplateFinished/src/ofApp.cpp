...
void ofApp::update(){
    ...
    //uncomment these after step 2 is complete
    ...
    //put your code below here----------------------------------
    modIndex = ofMap(mouseY, 0, ofGetHeight(),20,20000);
...
void ofApp::draw(){
    ...
    ofSetColor(0);
    myFont.drawString("Carrier Frequence " + carrierValue, 20, 40);
...
void ofApp::audioOut(ofSoundBuffer & buffer){
    ...
    //put your code below here-----------------------------------
        ...
        signal = carrier.sinewave(carrierFreq + modulator.sinewave(carrierFreq*modFreq)*modIndex) * (1-ampModulation.phasor(0.25));
        
        //This is our audio buffer and our speakers!
        audio[i] = buffer[i*buffer.getNumChannels()    ] = signal * amp;
        buffer[i*buffer.getNumChannels() + 1] = signal * amp;
...
void ofApp::mousePressed(int x, int y, int button){
    modFreq = ofMap(x, 0, ofGetWidth(), 0, 48);
}
